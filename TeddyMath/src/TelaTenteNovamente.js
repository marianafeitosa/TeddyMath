...
const TelaTenteNovamente = ({ route, navigation }) => {
...
>
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('SplashJogodaMemoria')} style={styles.reiniciarButton}>
...
export default TelaTenteNovamente;
